...
import { findTaskByOwner } from "@/api/task"
import { TaskPage } from "@/stores/pages/TaskPage"
import type { AsideTaskWithDegree } from "@/interface/task"

// === 获取数据 ===
const data = ref<AsideTaskWithDegree[]>()
findTaskByOwner().then(items => (data.value = items.data))
// ===============
