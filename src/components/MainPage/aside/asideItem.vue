  ...
  if (!switchAside.hasDiglog) {
    ...
    if (!pressed.value) {
      separatorStyle.left = isOutside.value ?
        divWidth.value + divLeft.value - widthControl.sepWidth / 2 + 'px' :
        divWidth.value + divLeft.value - widthControl.sepBoldWidth / 2 + 'px'
      separatorStyle.width = isOutside.value ?
        widthControl.sepWidth + 'px' :
        widthControl.sepBoldWidth + 'px'
